...
public class PowerSet {
  ...
  public static List<List<Integer>> generatePowerSet(List<Integer> inputSet) {
    ...
    generateSets(inputSet, powerSet, 0, new ArrayList<>());
    return powerSet;
  }
  public static void generateSets(List<Integer> inputSet, List<List<Integer>> powerSet, int toBeSelected, List<Integer> selectedSoFar) {
    if (toBeSelected == inputSet.size()) {
      powerSet.add(new ArrayList<>(selectedSoFar));
      return;
    }
    selectedSoFar.add(inputSet.get(toBeSelected));
    generateSets(inputSet, powerSet, toBeSelected + 1, selectedSoFar);
